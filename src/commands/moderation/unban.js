...
module.exports = {
  ...
  async execute(interaction) {
    ...
    const embed = new EmbedBuilder()
      .setColor(0x0f4a00)
      .setDescription(`:white_check_mark:  Woohoo! @${target.username} has been **unbanned**`);

    const dmEmbed = new EmbedBuilder()
      .setColor(0x0f4a00)
      .setDescription(`:white_check_mark:  Woohoo! You have been unbanned from ${interaction.guild.name}`);

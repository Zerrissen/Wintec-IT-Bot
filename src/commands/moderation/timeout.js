...
module.exports = {
    ...
    async execute(interaction) {
        ...
        if (interaction.member.id == targetMember.id) {
            return await interaction.reply({ content: 'You cannot timeout yourself, silly!' });
        }
        ...
        if (!targetMember.kickable) {
            return await interaction.reply({ content: 'User cannot be timed out due to them having greater permissions.' });
        }

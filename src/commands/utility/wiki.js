...
module.exports = {
  data: new SlashCommandBuilder()
    .setName("wiki")
    .setDescription("Search for a Wikipedia page and return its introduction")
  ...
  async execute(interaction) {
    ...
    try {
      ...
      const { extract, content_urls, thumbnail, originalimage } = summaryResponse.data;
      ...
      console.error(error);
      await interaction.reply("An error occurred while searching for the Wikipedia page.");
    }
  },
};
